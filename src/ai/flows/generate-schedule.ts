...
const generateSchedulePrompt = ai.definePrompt({
  ...
  - IMPORTANT: Some time slots have a 'label' (e.g., "UPACARA/PEMBINAAN", "DOA"). These time slots are reserved for that specific activity and MUST NOT be used for any class sessions. Do not generate any schedules for time slots that have a label.
